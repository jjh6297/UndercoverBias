...
X_test3 = X_test3.reshape(X_test3.shape[0], 32,32,3)
...
model.load_weights('pretrainedV2.h5')

output = model.predict([X_test3,X_train2],batch_size=batch_size)
...
sio.savemat('Watermarked_CIFAR10_testSet.mat', mdict = {'output':output, 'label':y_test3, 'watermark':output2, 'WLabel': y_train2})
sio.savemat('Clean_CIFAR10_testSet.mat', mdict = {'output':X_test3, 'label':y_test3, 'watermark':output2, 'WLabel': y_train2})
